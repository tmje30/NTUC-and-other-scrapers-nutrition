...
export interface StoreProduct {
	...
	url: string;
	/**
	 * Who is selling it — MARKETPLACES ONLY, where the listing is one stranger's rather
	 * than the shop's own catalogue. Undefined everywhere else, because "the seller" of a
	 * FairPrice product is FairPrice and recording that says nothing.
	 *
	 * Carried because on a marketplace the seller IS evidence: see
	 * `looksAutoGeneratedHandle` and `sellerReputation` in `stores/carousell.ts`.
	 */
	seller?: string;
	/**
