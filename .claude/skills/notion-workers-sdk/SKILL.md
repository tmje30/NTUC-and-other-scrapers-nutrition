---
name: notion-workers-sdk
description: Full Notion Workers SDK reference — the Worker/database/pacer/sync/tool/webhook/OAuth API, sync architecture (backfill + delta, replace mode, pagination, relations, schedules), the ntn CLI for managing and triggering syncs, querying data sources, reading run logs, and writing exec-based test scripts. Use when writing, changing, debugging, or testing any Notion Worker capability in this repo.
---

# Notion Workers SDK reference
